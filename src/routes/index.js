    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          path: 'leaveRequest',
          children: [
            { element: <Navigate to="/dashboard/leaveRequest/list" replace />, index: true },
            { path: 'list', element: <LeaveRequestList /> },
            { path: 'new', element: <LeaveRequest /> },
            { path: ':id/edit', element: <LeaveRequest /> },
            { path: ':id/view', element: <LeaveRequest /> },
          ],
        },
        //     {
        //       path: 'schedule',
